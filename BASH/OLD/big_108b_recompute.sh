...
for p in future
    ...
    # tail ./logs/"$r"_"$p"_108b_again.out
    # tail ./logs/"$r"_"$p"_108b_again.err

     echo "108 eventsplitting"
     Rscript --vanilla 108N_Event_Splitting.R $r $p > ./logs/"$r"_"$p"_108_again.out 2> ./logs/"$r"_"$p"_108_again.err
     tail ./logs/"$r"_"$p"_108_again.out
     tail ./logs/"$r"_"$p"_108_again.err
