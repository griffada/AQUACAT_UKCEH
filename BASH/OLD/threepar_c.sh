...
Rscript --vanilla 102b_Threshold_Extract.R $1 $2 > ./logs/"$1"_"$2"_102b.out 2> ./logs/"$1"_"$2"_102b.err
tail ./logs/"$1"_"$2"_102b.out
tail ./logs/"$1"_"$2"_102b.err
