...
# echo "101 running"
# Rscript --vanilla 101_YAML_creation.R $1 $2 FF > ./logs/"$1"_"$2"_FF101.out 2> ./logs/"$1"_"$2"_FF101.err
# tail ./logs/"$1"_"$2"_101.out
# tail ./logs/"$1"_"$2"_101.err

# echo "102 running"
# Rscript --vanilla 102f_Threshold_Extract.R $1 $2 FF > ./logs/"$1"_"$2"_FF102.out 2> ./logs/"$1"_"$2"_FF102.err
# tail ./logs/"$1"_"$2"_102.out
# tail ./logs/"$1"_"$2"_102.err

# echo "104 running"
# Rscript --vanilla 104b_Event_Extract.R $1 $2 FF > ./logs/"$1"_"$2"_FF104.out 2> ./logs/"$1"_"$2"_FF104.err
# tail ./logs/"$1"_"$2"_104.out
# tail ./logs/"$1"_"$2"_104.err

# echo "105N running"
# Rscript --vanilla 105N_Event_Summary.R $1 $2 FF > ./logs/"$1"_"$2"_FF105.out 2> ./logs/"$1"_"$2"_FF105.err
...
# echo "107N running"
# Rscript --vanilla 107cN_EmpiricalBeta_Copula.R $1 $2 FF > ./logs/"$1"_"$2"_FF107.out 2> ./logs/"$1"_"$2"_FF107.err
