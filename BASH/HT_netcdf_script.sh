...
# echo "108N running"
# python3 -u 108N_Event_Splitting.py $1 $2 > ./logs/"$1"_"$2"_108N.out 2> ./logs/"$1"_"$2"_108N.err
...
echo "109N running"
Rscript --vanilla 109N_HeffTawn_Modelling.R $1 $2 NW > ./logs/"$1"_"$2"_109N.out 2> ./logs/"$1"_"$2"_109N.err
...
echo "119N running"
Rscript --vanilla 119N_HT_tidying.R $1 $2 NW > ./logs/"$1"_"$2"_NW_119N.out 2> ./logs/"$1"_"$2"_NW_119N.err
